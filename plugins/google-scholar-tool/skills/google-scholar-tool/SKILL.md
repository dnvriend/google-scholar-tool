---
name: skill-google-scholar-tool
...
- When you need to use google-scholar-tool CLI tool
- When you need comprehensive guidance on CLI commands
- When you need examples and troubleshooting

# google-scholar-tool Skill

## Purpose

<!-- TODO: Expand with specific tool capabilities -->
This skill provides access to the `google-scholar-tool` CLI tool. A Python CLI tool.

## When to Use This Skill

**Use this skill when:**
<!-- TODO: Add specific scenarios, e.g., -->
- You need to understand how to use google-scholar-tool
- You need comprehensive examples and patterns
- You need troubleshooting guidance

**Do NOT use this skill for:**
<!-- TODO: Add anti-patterns, e.g., -->
- Tasks unrelated to google-scholar-tool
- Quick syntax lookups (use slash commands instead)

## CLI Tool: google-scholar-tool

<!-- TODO: Add tool overview -->
The `google-scholar-tool` is a command-line interface tool that A Python CLI tool.
...
**Usage:**
```bash
google-scholar-tool command-name ARGUMENT [OPTIONS]
```
...
```bash
# Example 1: Basic usage
google-scholar-tool command-name "example"

# Example 2: With options
google-scholar-tool command-name "example" --option value

# Example 3: Pipeline usage
google-scholar-tool command-name "example" --json | jq '.'
```
...
```bash
google-scholar-tool --help
google-scholar-tool COMMAND --help
```
...
google-scholar-tool command -v

# DEBUG level - see detailed info
google-scholar-tool command -vv

# TRACE level - see all internals
google-scholar-tool command -vvv
```
...
google-scholar-tool command --json | jq '.'
```
...
- **GitHub**: https://github.com/dnvriend/google-scholar-tool
- **Python Package Index**: https://pypi.org/project/google-scholar-tool/

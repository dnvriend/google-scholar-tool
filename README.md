...
`google-scholar-tool` is a Python CLI tool built with modern tooling and best practices.
...
google-scholar-tool -v      # INFO level
google-scholar-tool -vv     # DEBUG level
google-scholar-tool -vvv    # TRACE level (includes library internals)
```
...
google-scholar-tool -v
# Output:
# [INFO] google-scholar-tool started
# [INFO] google-scholar-tool completed

# DEBUG - see detailed information
google-scholar-tool -vv
# Output:
# [INFO] google-scholar-tool started
...
google-scholar-tool -vvv
```

### Customizing Library Logging

To enable DEBUG logging for third-party libraries at TRACE level (-vvv), edit `google_scholar_tool/logging_config.py`:
...
```bash
# Bash - add to ~/.bashrc
echo 'eval "$(google-scholar-tool completion bash)"' >> ~/.bashrc
source ~/.bashrc

# Zsh - add to ~/.zshrc
echo 'eval "$(google-scholar-tool completion zsh)"' >> ~/.zshrc
source ~/.zshrc
...
google-scholar-tool completion <TAB>
# Shows: bash zsh fish
```
...
google-scholar-tool completion --help
```
...
make run ARGS="..."          # Run google-scholar-tool locally
...
```
google-scholar-tool/
├── google_scholar_tool/    # Main package
│   ├── __init__.py
...
# Run with coverage
uv run pytest tests/ --cov=google_scholar_tool
```

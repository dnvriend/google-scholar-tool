...
- **Slash Commands**: Quick CLI invocations (e.g., `/google-scholar-tool:help`)
- **Skills**: Comprehensive documentation with progressive disclosure (e.g., `/skill-google-scholar-tool`)
...
**File**: `plugins/google-scholar-tool/.claude-plugin/plugin.json`
...
**Location**: `plugins/google-scholar-tool/commands/`
...
**Adding New Commands**:
1. Create `plugins/google-scholar-tool/commands/<command>.md`
...
```
/google-scholar-tool:help
/google-scholar-tool:command "argument"
```

## Skills

**Location**: `plugins/google-scholar-tool/skills/google-scholar-tool/SKILL.md`
...
**Usage in Claude Code**:
```
/skill-google-scholar-tool
```

Or:
```
Use the skill-google-scholar-tool to help me understand this tool
```
...
1. **Update the slash command** (optional):
   - Create `plugins/google-scholar-tool/commands/<command>.md`
...
3. `plugins/google-scholar-tool/.claude-plugin/plugin.json` → `version`
...
# Check plugin
cat plugins/google-scholar-tool/.claude-plugin/plugin.json | jq '.'

# List commands
ls plugins/google-scholar-tool/commands/

# Check skill
cat plugins/google-scholar-tool/skills/google-scholar-tool/SKILL.md
```

### Test in Claude Code
1. Open your project in Claude Code
2. Try slash command: `/google-scholar-tool:help`
3. Try skill: `/skill-google-scholar-tool`
